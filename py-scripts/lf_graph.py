...
class lf_bar_graph:
    ...
    def build_bar_graph(self):
        ...
        if self.xaxis_categories[0] == 0:
            ...
            plt.xticks(
                [i + self._xaxis_value_location for i in np.arange(0, len(self.data_set[0]), step=self.xaxis_step)],
...
class lf_bar_graph_horizontal:
    ...
    def build_bar_graph_horizontal(self):
        ...
        if self.yaxis_categories[0] == 0:
            ...
            plt.yticks(
                [i + self._yaxis_value_location for i in np.arange(0, len(self.data_set[0]), step=self.yaxis_step)],
